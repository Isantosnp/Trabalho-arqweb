package com.arquiteturaweb;


import com.arquiteturaweb.trabalho.TrabalhoApplication;
import com.arquiteturaweb.trabalho.repository.UserRepository;
import com.arquiteturaweb.trabalho.service.JwtService;
...
class AuthIntegrationTests {
    ...
    void setup() {
        userRepository.findByUsername("admin").ifPresentOrElse(
                user -> { /* Já existe */ },
                () -> {
                    com.arquiteturaweb.trabalho.model.User admin = new com.arquiteturaweb.trabalho.model.User(null, "admin", passwordEncoder.encode("123456"), "ADMIN");
        ...
        userRepository.findByUsername("user").ifPresentOrElse(
                user -> { /* Já existe */ },
                () -> {
                    com.arquiteturaweb.trabalho.model.User regularUser = new com.arquiteturaweb.trabalho.model.User(null, "user", passwordEncoder.encode("password"), "USER");
    ...
    void testLoginSuccess() throws Exception {
        ...
        assertTrue(jwtService.validateToken(token), "O token JWT deve ser válido."); 
    }
    @Test
